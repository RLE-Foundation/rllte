...
## NGU
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L67)
```python 
NGU(
...
### .compute_irs
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L117)
```python
.compute_irs(
...
### .update
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L164)
```python
.update(
   rollouts: Dict
)
...
## CnnEncoder
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L12)
```python 
CnnEncoder(
...
### .forward
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L37)
```python
.forward(
   obs: Tensor
)
...
## MlpEncoder
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L45)
```python 
MlpEncoder(
   obs_shape: Tuple, latent_dim: int
)
...
### .forward
[source](https://github.com/RLE-Foundation/Hsuanwu/blob/main/hsuanwu/xplore/reward/ngu.py/#L62)
```python
.forward(
   obs: Tensor
)

...
### .update
[source](https://github.com/RLE-Foundation/rllte/blob/main/rllte/agent/legacy/ddpg.py/#L138)
```python
.update()
```
...
### .update_critic
[source](https://github.com/RLE-Foundation/rllte/blob/main/rllte/agent/legacy/ddpg.py/#L179)
```python
.update_critic(
...
### .update_actor
[source](https://github.com/RLE-Foundation/rllte/blob/main/rllte/agent/legacy/ddpg.py/#L226)
```python
.update_actor(
   obs: th.Tensor
)

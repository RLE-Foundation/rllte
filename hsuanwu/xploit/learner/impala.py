...
class VTrace(object):
    ...
    def from_logits(self,
        ...
        behavior_action_log_probs = self.action_log_probs(behavior_policy_logits,
                                                    actions)
    ...
    @torch.no_grad()
    def from_importance_weights(self,
                                log_rhos,
                                discounts,
                                rewards,
                                values,
...
class IMPALALearner(BaseLearner):
    ...
    def update(
        ...
        with lock:
            learner_outputs, _ = learner(batch, actor_state)

...
from hsuanwu.xplore.noise.base import BaseActionNoise
...
class OrnsteinUhlenbeckActionNoise(BaseActionNoise):
    ...
    def __init__(self, 
                 ...
                 theta: float = 0.15,
                 dt: float = 1e-2,
                 initial_noise: Optional[Tensor] = None) -> None:
    ...
    def reset(self) -> None:
        ...
        """
        self.noise_prev = self.initial_noise if self.initial_noise is not None else torch.zeros_like(self._mu)

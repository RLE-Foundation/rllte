...
register_model_info(
    full_names=["rllte-vicuna-7b-v1.3"],
    simple_name="RLLTE",
    link="hub.rllte.dev",
    description="A reinforcement learning assistant based on vicuna-7b-v1.3.",
)

from fastchat.model.chatglm_model import chatglm_generate_stream
from rllte.copilot.falcon_model import falcon_generate_stream

...
learn_more_md = """
### Acknowledgement
This project is based on [FastChat](https://github.com/lm-sys/FastChat).
### License
...
def build_single_model_ui(models):
    notice_markdown = """
# 🤖 RLLTE Copilot: Intelligent Reinforcement Learning Assistant
"""
    ...
    header = """
    <div align="center">
    <img src='file/rllte/copilot/rllte-logo.png' style="width: 10%;vertical-align: middle;display: inline-block;">
    <span style="display: inline-block; vertical-align: middle; font-size: 30px;"> Intelligent Reinforcement Learning Assistant</span>
    </div>
    """
    gr.HTML(header)
...
def build_demo(models):
    with gr.Blocks(
        title="RLLTE Copilot",
        theme=gr.themes.Base().set(body_background_fill="zink"),
        css=block_css,
    ) as demo:

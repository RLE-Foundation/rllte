...
if __name__ == "__main__":
    ...
    exp_name = f"PPO_{env_name}_{args.intrinsic_reward}_obsRMS:{args.obs_rms}_rewNorm:{args.rwd_norm_type}_updateProp:{args.update_proportion}_rff:{args.int_gamma is not None}_weightInit:{args.weight_init}_s{args.seed}"

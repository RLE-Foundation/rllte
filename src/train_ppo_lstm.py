...
if __name__ == "__main__":
    ...
    exp_name = f"{'twoHeadPPO_LSTM' if args.two_head else 'PPO_LSTM'}_{env_name}_{args.intrinsic_reward}_obsRMS:{args.obs_rms}_rewNorm:{args.rwd_norm_type}_updateProp:{args.update_proportion}_weightInit:{args.weight_init}_s{args.seed}"
